...
class KeywordService(Service):
    ...
    @staticmethod
    def keyword_result(user_id: int, validated_data: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        prompt, scent_id, match_score = Service.result_prompt(json_str, "키워드")
        ...
        result = Service.keyword_save(user_id, scent_id, data, json_str, "K", match_score)
