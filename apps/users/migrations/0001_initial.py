    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("password", models.CharField(default="", max_length=128, verbose_name="비밀번호")),
                ("name", models.CharField(max_length=30, verbose_name="이름")),
                ("birthday", models.DateField(verbose_name="생년월일")),
                (
                    "social_type",
                    models.CharField(
                        choices=[("GENERAL", "General"), ("K", "Kakao"), ("N", "Naver"), ("G", "Google")],
                        default="GENERAL",
                        max_length=10,
                        verbose_name="가입 경로",
                    ),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("ACTIVE", "Active"), ("INACTIVE", "Inactive"), ("WITHDRAWN", "Withdrawn")],
                        default="ACTIVE",
                    ),
                ),
